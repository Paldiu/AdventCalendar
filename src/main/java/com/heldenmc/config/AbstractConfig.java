...
public abstract class AbstractConfig {
    ...
    public AbstractConfig(JavaPlugin plugin, File directory, String fileName) {
        this(plugin, null, directory, fileName);
    }

    public AbstractConfig(JavaPlugin plugin, String resourcePath, File directory, String fileName) {
        this.plugin = plugin;
